...
import { Settings, FileText, Users, Send, LayoutDashboard, HelpCircle, ExternalLink, BarChart3, GitBranch } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/sequences', label: 'Sequences', icon: GitBranch, description: 'Multi-step campaigns' },
  { path: '/analytics', label: 'Analytics', icon: BarChart3, description: 'Track & metrics' },
