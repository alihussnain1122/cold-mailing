...
export default function Sidebar() {
  return (
    <aside className="hidden lg:flex w-64 bg-white border-r border-stone-200 min-h-[calc(100vh-64px)] flex-col">
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {({ isActive }) => (
                  <>
                    <Icon className={`w-5 h-5 transition-colors ${isActive ? 'text-white' : 'text-stone-500 group-hover:text-stone-700'}`} aria-hidden="true" />
