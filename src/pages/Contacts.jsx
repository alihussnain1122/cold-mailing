        ...
        {paginatedContacts.length === 0 ? (
          <div className="text-center py-12">
            <div className="bg-stone-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              <Users className="w-8 h-8 text-stone-400" aria-hidden="true" />
            </div>
                ...
                <tbody>
                  {paginatedContacts.map((contact, index) => {
                    ...
                    const displayName = contact.firstName 
                      ...
                      : contact.name || '-';
                    return (
                      <tr key={contact.id} className="border-b border-stone-100 hover:bg-stone-50">
                        <td className="py-3 px-4 text-sm text-stone-400">{globalIndex}</td>
                        <td className="py-3 px-4 text-sm text-stone-900">{contact.email}</td>
